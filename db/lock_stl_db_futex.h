...
#ifndef YCSB_C_LOCK_STL_DB_FUTEX_H_
#define YCSB_C_LOCK_STL_DB_FUTEX_H_

#include "db/hashtable_db.h"

#include <string>
#include <vector>
#include "lib/lock_stl_hashtable_own_futex.h"

namespace ycsbc {

class LockStlDBFutex : public HashtableDB {
 public:
  LockStlDBFutex() : HashtableDB(
      new vmp::LockStlHashtableFutex<HashtableDB::FieldHashtable *>) { }
 ...
 protected:
  HashtableDB::FieldHashtable *NewFieldHashtable() {
    return new vmp::LockStlHashtableFutex<const char *>;
  }
